...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { country: @wine.country, description: @wine.description, evaluation: @wine.evaluation, name: @wine.name, type: @wine.type } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { country: @wine.country, description: @wine.description, evaluation: @wine.evaluation, name: @wine.name, type: @wine.type } }
